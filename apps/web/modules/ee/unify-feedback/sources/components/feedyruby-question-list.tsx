...
import { UNSUPPORTED_FEEDBACK_SOURCE_ELEMENT_TYPES } from "@feedyruby/types/feedback-source";
import { getTSurveyElementTypeEnumName } from "@/modules/survey/lib/elements";
import { Checkbox } from "@/modules/ui/components/checkbox";
import { Label } from "@/modules/ui/components/label";
import { TUnifySurvey } from "../types";

interface FeedyRubyQuestionListProps {
...
export const FeedyRubyQuestionList = ({
  survey,
  selectedQuestionIds,
  onQuestionToggle,
}: Readonly<FeedyRubyQuestionListProps>) => {
