...
const translations: Record<TranslationKey, TranslationValue> = {
  ...
  "common.powered_by_salamruby": "FeedyRuby · a TechRuby product",
  ...
  "emails.email_customization_preview_email_subject": "salamruby Email Customization Preview",
  ...
  "emails.embed_survey_preview_email_fight_spam":
    "Help us fight spam and forward this mail to hola@salamruby.com",
  "emails.embed_survey_preview_email_heading": "Preview Email Embed",
  "emails.embed_survey_preview_email_subject": "salamruby Email Survey Preview",
  ...
  "emails.forgot_password_email_subject": "Reset your salamruby password",
  ...
  "emails.invite_email_text_par2":
    "invited you to join them at salamruby. To accept the invitation, please click the link below:",
  "emails.invite_member_email_subject": "You're invited to collaborate on salamruby!",
  ...
  "emails.password_reset_notify_email_subject": "Your salamruby password has been changed",
  ...
  "emails.verification_email_subject": "Please verify your email to use salamruby",
  "emails.verification_email_survey_name": "Survey name",
  "emails.verification_email_take_survey": "Take survey",
  "emails.verification_email_text": "To start using salamruby please verify your email below:",
