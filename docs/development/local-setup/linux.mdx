---
title: Linux
description: How to set up FeedyRuby on a Linux machine
icon: "linux"
---

### Local Machine Setup - Linux

<Info>This guide is recommended for advanced users setting up FeedyRuby on a **Linux** machine.</Info>

Here are the requirements for setting up FeedyRuby on Linux:
...
1. **Clone the repository and move into the directory:**
   ...
   ```bash
   git clone https://github.com/feedyruby/feedyruby && cd feedyruby
   ```
...
You can now access FeedyRuby at [http://localhost:3000](http://localhost:3000).
