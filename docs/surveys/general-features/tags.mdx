...
- **View tags**: All users with access to the Workspace can view tags on responses
- **Add/remove tags on responses**: Users with read-write access can apply and remove tags
- **Manage tags** (create, edit, merge, delete): Users with Workspace team read-write permission or organization owner/manager roles
