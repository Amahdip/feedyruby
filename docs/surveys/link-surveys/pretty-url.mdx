...
<Note>
  **Self-Hosted Only**: Pretty URLs are available exclusively on self-hosted FeedyRuby instances. This feature is not available on FeedyRuby Cloud.
</Note>
...
| Uniqueness | Must be unique across your entire FeedyRuby instance |
