---
title: "Zapier"
description: "Master the integration of FeedyRuby with Zapier using our detailed guide. Seamlessly connect your surveys to 5000+ apps, automate data transfers, and enhance feedback management. Start optimizing your workflow today."
---
...
Go to [zapier.com](https://zapier.com) and create a new Zap. Search for “FeedyRuby” to get started:
...
## Step 4: Connect FeedyRuby with Zapier

Now, you have to connect Zapier with FeedyRuby via an API Key:

![Connect with FeedyRuby - 1](/images/xm-and-surveys/core-features/integrations/zapier/connect-with-feedyruby-1.webp)

![Connect with FeedyRuby - 2](/images/xm-and-surveys/core-features/integrations/zapier/connect-with-feedyruby-2.webp)
