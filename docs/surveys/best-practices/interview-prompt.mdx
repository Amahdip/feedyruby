...
1. Create new Interview Prompt at [app.feedyruby.com](https://app.feedyruby.com/)
...
<Note>
  FeedyRuby Widget running? We assume that you have already installed the FeedyRuby Widget in your web app. It’s required to display messages and surveys in your app. If not, please follow the [Quick Start Guide (15mins)](/xm-and-surveys/surveys/website-app-surveys/quickstart)
</Note>
...
Click on "Create Survey" and choose the template [Interview Prompt](https://feedyruby.com/survey-templates/interview-prompt):
...
Update the prompt, description and button text to match your products tonality. You can also update the button color in the Workspace Settings.
