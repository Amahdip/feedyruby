...
description: "Configure third-party integrations with FeedyRuby Cloud."
---

At FeedyRuby, we understand the importance of integrating with third-party applications. We have step-by-step guides to configure our third-party integrations with FeedyRuby Cloud.&#x20;
...
* [Wordpress](/xm-and-surveys/core-features/integrations/wordpress)(Open Source): Automatically integrate your FeedyRuby surveys with your Wordpress website.

* [Zapier](/xm-and-surveys/core-features/integrations/zapier): Connect FeedyRuby with 2000+ apps on Zapier.

***

If you have any questions or need help with any of the integrations or even want a new integration, please reach out to us on [Github Discussions](https://github.com/feedyruby/feedyruby/discussions).