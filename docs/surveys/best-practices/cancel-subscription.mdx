...
description: "Mastering Churn Surveys with FeedyRuby | Essential Tips & Steps"
...
1. Create new Churn Survey at [app.feedyruby.com](https://app.feedyruby.com/)
...
<Note>
  ### FeedyRuby Widget running? We assume that you have already installed the

  FeedyRuby Widget in your web app. It’s required to display messages and
...
Click on "Create Survey" and choose the template [Churn Survey](https://feedyruby.com/survey-templates/churn-survey):
...
*Want to change the button color? You can do so in the Workspace settings.*
