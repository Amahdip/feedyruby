...
description: "Build and manage your own research panel using FeedyRuby to collect profiling data, create targeted segments, and distribute personalized survey links to panel members."
...
FeedyRuby provides all the tools you need to build and manage a research panel:
...
<Steps>
  <Step title="Create a profiling survey">
    ...
    1. Go to [app.feedyruby.com](https://app.feedyruby.com) and click **Create Survey**
  ...
  <Step title="Download the example contact upload CSV">
    ...
    1. Go to the **Contacts** section in your Workspace
    ...
    The example CSV shows you the format FeedyRuby expects for contact uploads, including required fields like email and optional attribute columns.
  </Step>
  ...
  <Step title="Upload contacts to FeedyRuby">
    Import your panel members into FeedyRuby:
    ...
    Your panel members are now stored in FeedyRuby with their profiling attributes.
  </Step>
...
| **Reusability** | Use the same panel for multiple research initiatives |
