...
icon: "key"
description: "Here is how you can generate an API key which gives you full access to the FeedyRuby Management API. Keep it safe!"
---
...
<Steps>
  ...
  <Step title="Configure your API key">
    ...
    2. Configure Workspace access:
       - Select which Workspaces this key should have access to
       - Choose the permission level for each (read, write, or manage)
       - You can add access to multiple Workspaces by clicking "Add Permission"
