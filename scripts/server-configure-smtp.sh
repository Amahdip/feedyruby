#!/usr/bin/env bash
# Configure FeedyRuby on the survey VPS to send mail via mail.feedyruby.ir.
# Prerequisite: survey server IP (37.32.10.71) is allowed in Postfix mynetworks on mail-feedyruby.
set -euo pipefail
...
log "Recreating feedyruby container..."
