...
```
https://feedyruby.com/s/clin34bjy?screen=pricing
```

Multiple Hidden Fields:

```
https://feedyruby.com/s/clin34bjy?screen=landing_page&job=Founder
```
...
```js
feedyruby.track("action_name", {hiddenFields: {myField: "value"}})
```
