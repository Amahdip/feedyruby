...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        fr: {
          violet: "var(--fr-violet)",
          fuchsia: "var(--fr-fuchsia)",
        ...
        brand: {
          DEFAULT: "var(--feedyruby-brand, #EC4899)",
          light: "var(--feedyruby-brand, #EC4899)",
          dark: "var(--feedyruby-brand, #EC4899)",
        },
        focus: "var(--feedyruby-focus, #1982fc)",
        // error: "rgb(from var(--feedyruby-error) r g b / <alpha-value>)",
        brandnew: "var(--feedyruby-brand, #038178)",
        primary: {
          DEFAULT: "#0f172a",
          foreground: "#fefefe",
        },
