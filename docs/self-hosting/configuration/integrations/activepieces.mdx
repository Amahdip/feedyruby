...
## Setting Up ActivePieces with Self-Hosted FeedyRuby

### Prerequisites
- A self-hosted FeedyRuby instance
- Access to an ActivePieces account

### Configuration Steps

For general setup instructions, refer to our [comprehensive ActivePieces integration guide](https://feedyruby.com/docs/xm-and-surveys/core-features/integrations/activepieces).
...
Instead of using `app.feedyruby.com` as your `APP_URL`, you must substitute this with your own self-hosted FeedyRuby instance URL.
...
- Ensure your self-hosted FeedyRuby instance is accessible from the internet
