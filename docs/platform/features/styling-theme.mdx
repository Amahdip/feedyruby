...
<Note>
  **Self-Hosting Requirements**: Uploading custom background images and brand logos requires file upload
  storage to be configured. If you're self-hosting FeedyRuby, make sure to [configure file
...
In the left side bar, you find the `Settings` page. On this page you find the `Appearance` section:

![Appearance](/images/xm-and-surveys/core-features/styling-theme/form-css-styling.webp)
...
<Steps>
  <Step title="Open Logo Settings">
    In the **Appearance** page in Workspace settings, scroll down to the **Logo Upload** box.
