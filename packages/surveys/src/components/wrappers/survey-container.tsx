...
import { type TOverlay, type TPlacement } from "@feedyruby/types/common";
...
export function SurveyContainer({
  ...
  if (!isModal) {
    return (
      <div id="fbjs" className="feedyruby-form" style={{ height: "100%", width: "100%" }} dir={dir}>
        {children}
      </div>
    );
  }
  ...
  return (
    <div id="fbjs" className="feedyruby-form" dir={dir}>
      <div
        aria-live="assertive"
        className={cn(
