  ...
  return (
    <>
      ...
      <Alert>
        ...
        <AlertDescription>
          {t("workspace.surveys.share.social_media.source_tracking_enabled_alert_description")}
        </AlertDescription>
        <AlertButton
          onClick={() => {
            window.open(
              "https://feedyruby.com/docs/xm-and-surveys/surveys/link-surveys/source-tracking",
              "_blank",
              "noopener,noreferrer"
            );
          }}>
