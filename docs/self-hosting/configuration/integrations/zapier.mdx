...
Setup your Zap: Go to [zapier.com](https://zapier.com/) and create a new Zap. Search for “FeedyRuby” to get started:
...
Connect FeedyRuby with Zapier: You have to connect Zapier with FeedyRuby via an API Key:
...
Voila! You have successfully configured Zapier to work with your self-hosted FeedyRuby instance. Now, you can follow the steps mentioned in the [Zapier Integration](https://feedyruby.com/docs/developer-docs/integrations/zapier) section to connect it with your FeedyRuby app and see it live.
