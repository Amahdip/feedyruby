...
import { type TSurveyCsatElement, type TSurveyElement } from "@feedyruby/types/surveys/elements";
    ...
    <form>
      ...
      <div className="flex justify-between gap-8">
        <div className="flex-1">
          <ElementFormInput
            id="lowerLabel"
            placeholder={t("templates.csat_lower_label")}
        ...
        <div className="flex-1">
          <ElementFormInput
            id="upperLabel"
            placeholder={t("templates.csat_upper_label")}
