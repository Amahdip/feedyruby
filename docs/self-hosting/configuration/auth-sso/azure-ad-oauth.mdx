...
description: "Configure Microsoft Entra ID (Azure AD) OAuth for secure Single Sign-On with your FeedyRuby instance. Use enterprise-grade authentication for your survey platform."
icon: "microsoft"
---

<Note>AzureAD OAuth is part of the FeedyRuby [Enterprise Edition](/self-hosting/advanced/license)</Note>

### Microsoft Entra ID

Do you have a Microsoft Entra ID Tenant? Integrate it with your FeedyRuby instance to allow users to log in using their existing Microsoft credentials. This guide will walk you through the process of setting up an Application Registration for your FeedyRuby instance.
...
- A FeedyRuby instance running and accessible.

- The callback URI for your FeedyRuby instance: `{WEBAPP_URL}/api/auth/callback/azure-ad`

## How to connect your FeedyRuby instance to Microsoft Entra
...
<Steps>
  ...
  <Step title="Configure the application">
    - Name your application something descriptive, such as `FeedyRuby SSO`.
    ...
    - Under **Redirect URI**, select **Web** for the platform and paste your FeedyRuby callback URI (see Requirements above).
  ...
  <Step title="Update environment variables">
    - Update these environment variables in your `docker-compose.yml` or pass it like your other environment variables to the FeedyRuby container.
    ...
    An example `.env` for Microsoft Entra ID in FeedyRuby would look like this:

    ```yml FeedyRuby Env for Microsoft Entra ID SSO
