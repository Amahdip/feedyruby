...
| Column | Description |
|--------|-------------|
| **FeedyRuby Contact ID** | Internal contact identifier (`contactId`) |
...
- **CSV storage**: Generated link lists are not retained in FeedyRuby - download and store your CSV files securely
