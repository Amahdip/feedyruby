...
<Note>
  **Self-Hosting Requirements**: This question type requires file upload storage to be configured for image
  uploads. If you're self-hosting FeedyRuby, make sure to [configure file
...
<iframe
  title="Survey Embed"
  src="https://app.feedyruby.com/s/xtgmwxlk7jxxr4oi6ym7odki"
  style={{
    position: "relative",
    height: "600px",
    maxHeight: "100vh",
...
This option allows the user to select more than one image.
