...
**FeedyRuby Hub** is FeedyRuby' unified feedback data layer. It stores normalized feedback from multiple input channels so teams can query, analyze, and act on it in one place.
...
To learn more, visit the Hub docs at [hub.feedyruby.com](https://hub.feedyruby.com) and the [Hub API Reference](https://hub.feedyruby.com/api).
