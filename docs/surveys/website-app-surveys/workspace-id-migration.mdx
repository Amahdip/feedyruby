...
FeedyRuby deprecated the legacy Environment ID for SDK setup and now uses **Workspace ID** as the primary identifier.
...
FeedyRuby moved from an environment-centric model to a workspace-centric model to simplify setup, reduce confusion,
...
<Steps>
  <Step title="Open Connect Your App">
    In FeedyRuby, go to **Settings → Connect Your App**.
  </Step>
...
Use the [Framework Guides](https://feedyruby.com/docs/xm-and-surveys/surveys/website-app-surveys/framework-guides)
