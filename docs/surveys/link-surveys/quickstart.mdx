...
<Steps>
  <Step title="Create a free FeedyRuby Cloud account">
    While you can [self-host](/self-hosting/overview) FeedyRuby, the quickest and easiest way to get started is with the free Cloud plan. Just [sign up here](https://app.feedyruby.com/auth/signup) and click through the onboarding.
  ...
  <Step title="Configure your survey settings">
    FeedyRuby packs a lot of useful functionality out of the box. You can:
...
<Step title="Share your survey">
    Congratulations! Your survey is now published and ready to be shared with your users. You can share the survey link via email, SMS, or any other channel you prefer.
</Step>
</Steps>