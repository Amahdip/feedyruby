---
title: "Understanding FeedyRuby Survey Types"
sidebarTitle: "Survey Types 101"
description: "This guide explains the differences between FeedyRuby Link Surveys and Website & App Surveys to help you choose the right option."
...
| **Segmentation** | You control externally | Built-in via FeedyRuby |
...
```
https://app.feedyruby.com/s/<surveyId>?embed=true&userId=123
```
...
window.addEventListener("message", (event) => {
  if (event.data === "feedyrubySurveyCompleted") {
    closeWebView();
  }
});
```
...
- You don't need FeedyRuby attribute-based targeting & survey fatigue controls


## Website & App Surveys (SDK)

Also known as **intercept surveys**. Requires SDK integration. FeedyRuby handles targeting, triggering, and survey fatigue.
...
- You want FeedyRuby to handle who sees which survey
...
**Need help?** [Join us in GitHub Discussions](https://github.com/feedyruby/feedyruby/discussions)
