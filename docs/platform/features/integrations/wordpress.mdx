---
title: "Wordpress"
description: "Target specific visitors with a survey on your WordPress page using FeedyRuby for free. Show survey on specific page or on button click."
---

To run a targeted survey on your WordPress website, FeedyRuby is the way to go!&#x20;
...
1. Install the FeedyRuby WordPress plugin

2. Create a [free FeedyRuby account](https://app.feedyruby.com/auth/signup)

3. Find and copy the `workspaceId`

4. Copy the `workspaceId` into the right field in the plugin settings

5. Create survey on trigger “New Session” to test it

## Step 1: Install the FeedyRuby WordPress plugin

As long as the FeedyRuby plugin is in review, please download it from our [GitHub repository directly.](https://github.com/feedyruby/wordpress)
...
## Step 2: Create a FeedyRuby Account

This is super straight forward: Go to [app.feedyruby.com/auth/signup](https://app.feedyruby.com/auth/signup), create the account, verify your email and you’re in!
...
## Step 3: Find and copy the workspaceId

Go to `Settings` > `Connect Your App` where you’ll find your workspaceId:
...
## Step 4: Copy the workspaceId to the WordPress Plugin Settings

In your WordPress instance, go to the FeedyRuby Plugin settings and copy the workspaceId in the correct field:
...
If you have any questions or need help, feel free to reach out to us on [Github Discussions](https://github.com/feedyruby/feedyruby/discussions)
