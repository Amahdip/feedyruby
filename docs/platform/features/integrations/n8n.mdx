---
title: "n8n"
description: "Integrate FeedyRuby with n8n for a streamlined workflow experience."
---

<Note>
  The FeedyRuby n8n node is currently only available in the n8n self-hosted
  version as a community node. To install it go to "Settings" -> "Community
  Nodes" and install @feedyruby/n8n-nodes-feedyruby.
</Note>

n8n allows you to build flexible workflows focused on deep data integration. And with sharable templates and a user-friendly UI, the less technical people on your team can collaborate on them too. Unlike other tools, complexity is not a limitation. So you can build whatever you want — without stressing over budget. Hook up FeedyRuby with n8n and you can send your data to 350+ other apps. Here is how to do it.
...
Go to [n8n.io](https://n8n.io) and create a new workflow. Search for “FeedyRuby” to get started:

![Add FeedyRuby Trigger](/images/xm-and-surveys/core-features/integrations/n8n/add-feedyruby-trigger.webp)

## Step 3: Connect FeedyRuby with n8n

Now, you have to connect n8n with FeedyRuby via an API Key:
