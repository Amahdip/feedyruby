...
description: "Set up email functionality for your self-hosted FeedyRuby instance"
icon: "envelope"
---

By default, FeedyRuby doesn't include an SMTP server for sending emails. However, you can easily configure your self-hosted instance to use your own email provider through environment variables.

## Why Configure SMTP?

Setting up an SMTP server enables important email functionality in FeedyRuby, including:
...
FeedyRuby uses Nodemailer to send emails and supports various SMTP providers like:
...
By default, email verification and password reset features are **disabled** in FeedyRuby. To enable these features:
